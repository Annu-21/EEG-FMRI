...
eeg=mne.io.read_raw_brainvision("C:/Users/Anjali Singh/Downloads/eegfmri/russell/6 rest.vhdr",preload=True)
eeg_r1=mne.io.read_raw_brainvision("C:/Users/Anjali Singh/Downloads/eegfmri/russell/2-gamma.vhdr",preload=True)
eeg_r2=mne.io.read_raw_brainvision("C:/Users/Anjali Singh/Downloads/eegfmri/russell/4 gamma.vhdr",preload=True)
...
axes[0].set_title("Russel-rest")
axes[1].set_title("Russel-retino-1")
axes[2].set_title("Russel-retino-2")
plt.tight_layout()
...
axes[0][0].set_title("Russel-rest--not subtracted"); axes[0][1].set_title("Russel-rest-subtracted")
axes[1][0].set_title("Russel-retino1-not subtracted"); axes[1][1].set_title("Russel-retino1-not subtracted")
axes[2][0].set_title("Russel-retino2-not subtracted"); axes[2][1].set_title("Russel-retino2-not subtracted")
plt.tight_layout()
...
axes[0][0].set_title("Russel-rest"); axes[0][1].set_title("Russel-rest-after BCG removal")
axes[1][0].set_title("Russel-retino1"); axes[1][1].set_title("Russel-retino1-after BCG removal")
axes[2][0].set_title("Russel-retino2"); axes[2][1].set_title("Russel-retino2-after BCG removal")
plt.tight_layout()
...
good_comp_a=sources_a[[8,15],:] #components that have peak in 8-13 HZ band i.e., alpha band are good components
#alpha components
...
#Retino-2
good_comp_r2=sources_r2[[9,19,20],:]
#alpha components
...
bold_a=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_rest.nii.gz").get_fdata()
...
#gamma
                                          #ALEX-gamma
import nibabel as nib
bold_a1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_rest.nii.gz").get_fdata()
...
#correlate with bold
                                          #ALEX-alpha-retino-1
import nibabel as nib
bold_r1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_01.nii.gz").get_fdata()
#creating an empty 4d array
...
#gamma
                                          #ALEX-gamma-retino-1
import nibabel as nib
bold_g_r1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_01.nii.gz").get_fdata()
...
#correlate with bold
                                          #ALEX-alpha-retino-2
import nibabel as nib
bold_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_02.nii.gz").get_fdata()
#creating an empty 4d array
...
#gamma
                                          #ALEX-gamma-retino-2
import nibabel as nib
bold_g_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_02.nii.gz").get_fdata()
...
mean_bold_a = nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_rest.nii.gz")
...
if isinstance(mean_bold_a, nib.Nifti1Image):
    ...
    nib.save(cmap_a, 'C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_rest_alpha.nii.gz')
else:
    print("mean_bold_a is not a NIfTI image object.")

import nibabel as nib
# Load the NIfTI image
mean_bold_r1 = nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_rest.nii.gz")
# Check if mean_bold_r1 is a NIfTI image
if isinstance(mean_bold_r1, nib.Nifti1Image):
    ...
    # Save the new NIfTI image
    nib.save(cmap_r1, 'C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino1_alpha.nii.gz')
else:
    print("mean_bold_r1 is not a NIfTI image object.")

mean_bold_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_02.nii.gz")
cmap_r2=nib.Nifti1Image(corrmap_alex_retino2_r2,mean_bold_r2.affine,mean_bold_r2.header)
nib.save(cmap_r2,'C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino2_alpha.nii.gz')

#Gamma
mean_bold_g=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_rest.nii.gz")
cmap_g=nib.Nifti1Image(corrmap_alex_rest_gamma,mean_bold_g.affine,mean_bold_g.header)
nib.save(cmap_g,'C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_rest_gamma.nii.gz')

mean_bold_g_r1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_01.nii.gz")
cmap_g_r1=nib.Nifti1Image(corrmap_alex_retino1_gamma,mean_bold_g_r1.affine,mean_bold_g_r1.header)
nib.save(cmap_g_r1,'C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino1_gamma.nii.gz')

mean_bold_g_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/retino_gamma_02.nii.gz")
cmap_g_r2=nib.Nifti1Image(corrmap_alex_retino2_gamma,mean_bold_g_r2.affine,mean_bold_g_r2.header)
nib.save(cmap_g_r2,'C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino2_gamma.nii.gz')


# In[28]:


t1_alex = nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/russell/t1.nii.gz").get_fdata()


# In[33]:


alex_rest_alpha=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_rest_alpha.nii.gz').get_fdata()
plt.subplot(231)
alex_rest_alpha.shape
plt.imshow(alex_rest_alpha[:, :,26], cmap='viridis', alpha=0.5)
plt.title('russell-rest-alpha')
plt.axis('off')

alex_retino1_alpha=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino1_alpha.nii.gz').get_fdata()
plt.subplot(232)
plt.imshow(alex_retino1_alpha[:, :, 14], cmap='viridis')
plt.title('russell-retino-1-alpha')
plt.axis('off')

alex_retino2_alpha=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino2_alpha.nii.gz').get_fdata()
plt.subplot(233)
plt.imshow(alex_retino2_alpha[:, :, 23], cmap='viridis')
plt.title('russell-retino-2-alpha')
plt.axis('off')
...
#Gamma
alex_rest_gamma=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_rest_gamma.nii.gz').get_fdata()
plt.subplot(231)
alex_rest_gamma.shape
plt.imshow(alex_rest_gamma[:, :,20], cmap='viridis', alpha=0.5)
plt.title('russel-rest-gamma')
plt.axis('off')

alex_retino1_gamma=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino1_gamma.nii.gz').get_fdata()
plt.subplot(232)
plt.imshow(alex_retino1_gamma[:, :, 18], cmap='viridis')
plt.title('russel-retino-1-gamma')
plt.axis('off')

alex_retino2_gamma=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/russell/corrmap_alex_retino2_gamma.nii.gz').get_fdata()
plt.subplot(233)
plt.imshow(alex_retino2_gamma[:, :, 15], cmap='viridis')
plt.title('russel-retino-2-gamma')
plt.axis('off')
...
plt.title("Russell-alpha-average")

plt.subplot(222)
plt.imshow(average_corr_map_gamma[:,:,17],cmap='viridis')
plt.title("Russell-gamma-average")
...
plt.title("Russell-alpha-overlay over T1")
plt.show() 
...
plt.imshow(np.rot90(overlay_alpha[:, :, 23]), cmap="viridis")
plt.title("Russell-gamma-overlay over T1")
plt.show()
