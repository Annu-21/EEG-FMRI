...
eeg=mne.io.read_raw_brainvision("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/genevieve_rest.vhdr",preload=True)
eeg_r1=mne.io.read_raw_brainvision("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_01.vhdr",preload=True)
eeg_r2=mne.io.read_raw_brainvision("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_02.vhdr",preload=True)
...
axes[0].set_title("Genevieve-rest")
axes[1].set_title("Genevieve-retino-1")
axes[2].set_title("Genevieve-retino-2")
plt.tight_layout()
...
axes[0][0].set_title("Genevieve-rest--not subtracted"); axes[0][1].set_title("Genevieve-rest-subtracted")
axes[1][0].set_title("Genevieve-retino1-not subtracted"); axes[1][1].set_title("Genevieve-retino1-not subtracted")
axes[2][0].set_title("Genevieve-retino2-not subtracted"); axes[2][1].set_title("Genevieve-retino2-not subtracted")
plt.tight_layout()
...
axes[0][0].set_title("Genevieve-rest"); axes[0][1].set_title("Genevieve-rest-after BCG removal")
axes[1][0].set_title("Genevieve-retino1"); axes[1][1].set_title("Genevieve-retino1-after BCG removal")
axes[2][0].set_title("Genevieve-retino2"); axes[2][1].set_title("Genevieve-retino2-after BCG removal")
plt.tight_layout()
...
#Plotting power spectral density of each source
...
#Plotting power spectral density of each source-retino-1
...
#Plotting power spectral density of each source-retino-2
...
good_comp_a=sources_a[[12,14,16],:] #components that have peak in 8-13 HZ band i.e., alpha band are good components
#alpha components
...
#Retino-1
good_comp_r1=sources_r1[[16,17,19],:]
#alpha components
...
#Retino-2
good_comp_r2=sources_r2[[17,25,28],:]
#alpha components
...
bold_a=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_rest.nii.gz").get_fdata()
...
#gamma
                                          #Gen-gamma
import nibabel as nib
bold_a1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_rest.nii.gz").get_fdata()
...
#correlate with bold
                                          #Gen-alpha-retino-1
import nibabel as nib
bold_r1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_01.nii.gz").get_fdata()
#creating an empty 4d array
...
#gamma
                                          #Gen-gamma-retino-1
import nibabel as nib
bold_g_r1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_01.nii.gz").get_fdata()
...
#correlate with bold
                                          #Gen-alpha-retino-2
import nibabel as nib
bold_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_02.nii.gz").get_fdata()
#creating an empty 4d array
...
#gamma
                                          #Gen-gamma-retino-2
import nibabel as nib
bold_g_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_02.nii.gz").get_fdata()
...
mean_bold_a = nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_rest.nii.gz")
...
if isinstance(mean_bold_a, nib.Nifti1Image):
    ...
    nib.save(cmap_a, 'C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_rest_alpha.nii.gz')
else:
    print("mean_bold_a is not a NIfTI image object.")

import nibabel as nib
# Load the NIfTI image
mean_bold_r1 = nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_rest.nii.gz")
# Check if mean_bold_r1 is a NIfTI image
if isinstance(mean_bold_r1, nib.Nifti1Image):
    ...
    # Save the new NIfTI image
    nib.save(cmap_r1, 'C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_retino1_alpha.nii.gz')
else:
    print("mean_bold_r1 is not a NIfTI image object.")

mean_bold_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_02.nii.gz")
cmap_r2=nib.Nifti1Image(corrmap_alex_retino2_r2,mean_bold_r2.affine,mean_bold_r2.header)
nib.save(cmap_r2,'C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_retino2_alpha.nii.gz')

#Gamma
mean_bold_g=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_rest.nii.gz")
cmap_g=nib.Nifti1Image(corrmap_alex_rest_gamma,mean_bold_g.affine,mean_bold_g.header)
nib.save(cmap_g,'C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_rest_gamma.nii.gz')

mean_bold_g_r1=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_01.nii.gz")
cmap_g_r1=nib.Nifti1Image(corrmap_alex_retino1_gamma,mean_bold_g_r1.affine,mean_bold_g_r1.header)
nib.save(cmap_g_r1,'C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_retino1_gamma.nii.gz')

mean_bold_g_r2=nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/retino_gamma_02.nii.gz")
cmap_g_r2=nib.Nifti1Image(corrmap_alex_retino2_gamma,mean_bold_g_r2.affine,mean_bold_g_r2.header)
nib.save(cmap_g_r2,'C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_retino2_gamma.nii.gz')


# In[31]:


t1 = nib.load("C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/t1.nii.gz").get_fdata()


# In[44]:


alex_rest_alpha=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_rest_alpha.nii.gz').get_fdata()
plt.subplot(231)
alex_rest_alpha.shape
plt.imshow(alex_rest_alpha[:, :,16], cmap='viridis', alpha=0.5)
plt.title('Gen-rest-alpha')
plt.axis('off')

alex_retino1_alpha=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_retino1_alpha.nii.gz').get_fdata()
plt.subplot(232)
plt.imshow(alex_retino1_alpha[:, :, 13], cmap='viridis')
plt.title('Gen-retino-1-alpha')
plt.axis('off')

alex_retino2_alpha=nib.load('C:/Users/Anjali Singh/Downloads/eegfmri/genevieve/corrmap_alex_retino2_alpha.nii.gz').get_fdata()
plt.subplot(233)
plt.imshow(alex_retino2_alpha[:, :, 16], cmap='viridis')
plt.title('Gen-retino-2-alpha')
plt.axis('off')
...
plt.title("Genevieve-alpha-average")

plt.subplot(222)
plt.imshow(average_corr_map_gamma[:,:,17],cmap='viridis')
plt.title("Genevieve-gamma-average")
...
scale_factors = (
    average_corr_map_alpha.shape[0] / t1.shape[0],
    average_corr_map_alpha.shape[1] / t1.shape[1],
    average_corr_map_alpha.shape[2] / t1.shape[2]
)

# Resize the t1_alex array to match the size of average_corr_map_alpha
resized_t1 = zoom(t1, scale_factors, order=1)
alpha=0.5
overlay_alpha = average_corr_map_alpha + alpha * resized_t1

plt.imshow(np.rot90(overlay_alpha[:, :, 24]), cmap="viridis")
plt.title("Genevieve-alpha-overlay over T1")
plt.show() 
...
# Calculate the scaling factors for each axis
scale_factors = (
    average_corr_map_gamma.shape[0] / t1.shape[0],
    average_corr_map_gamma.shape[1] / t1.shape[1],
    average_corr_map_gamma.shape[2] / t1.shape[2]
)

# Resize the t1_alex array to match the size of average_corr_map_alpha
resized_t1 = zoom(t1, scale_factors, order=1)
alpha=0.5
overlay_alpha = average_corr_map_gamma + alpha * resized_t1
